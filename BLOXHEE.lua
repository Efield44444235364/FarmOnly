...
local Tabs = {
     ...
     hee = Window:AddTab({ Title = "status", Icon = "" }),
     moi = Window:AddTab({ Title = "Teleport World kaEngo", Icon = "" }),
...
Tabs.moi:AddButton({
        ...
        Callback = function()
            Window:Dialog({
                ...
                Buttons = {
                    {
                        Title = "ไปค่ะอิบ้านนอก",
                        Callback = function()
   game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
                        end
                    },
                    {
                        Title = "กุไม่ไปค่ะ อีแก่",
                        Callback = function()
...
Tabs.moi:AddButton({
        ...
        Callback = function()
            Window:Dialog({
                ...
                Buttons = {
                    {
                        Title = "ไปค่ะ อีกระหรี่",
                        Callback = function()
   game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")	
                        end
                    },
                    {
                        Title = "กุไม่ไปค่ะอิโง่",
                        Callback = function()
                            print("Cancelled the dialog.")
                        end
                    }
