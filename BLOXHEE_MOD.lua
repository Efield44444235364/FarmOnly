...
local Window = Fluent:CreateWindow({
    ...
    SubTitle = "test script fram only!!!!",
    TabWidth = 100,
...
local Tabs = {
    Main = Window:AddTab({ Title = "Dough king ", Icon = "" }),
} local Options = Fluent.Options



local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Farm Katakuri", Default = false}); Toggle:OnChanged(function(Value)
